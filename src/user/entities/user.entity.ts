...
export class User {
    ...
    @OneToMany(() => Publication, (publication: Publication) => publication.publicant, {cascade: true, nullable: true})
    ...
    @OneToMany(() => UserReviews, (userReviews: UserReviews) => userReviews.user, {cascade: true, nullable: true})
    reviews: UserReviews[] | null;

    @OneToMany(() => UserNotes, (userNotes: UserNotes) => userNotes.user, {cascade: true, nullable: true})
    notes: UserReviews[] | null;

    @CreateDateColumn({type: "timestamp"})
    registeredDate: Date;

    @OneToMany(() => PublicationReviews, (publicationReviews: PublicationReviews) => publicationReviews.reviewer, {cascade: true, nullable: true})
